                          ...
                          <AnimatePresence>
                            {expandedDate === date && (
                              <motion.div
                                ...
                                transition={{ duration: 0.2 }}>
                                <div className="mt-1 grid h-full max-h-[120px] grid-cols-1 gap-1 overflow-y-auto pl-2 sm:mt-1.5 sm:max-h-[300px] sm:gap-2 sm:pl-4">
                                  {reviews.map((review) => (
                                    <motion.li
                                      ...
                                      transition={{ duration: 0.2 }}
                                      key={review.id}>
                                      <div className="rounded-md bg-background p-1 text-[10px] sm:p-2 sm:text-sm">
